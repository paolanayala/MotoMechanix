...
class Cli {
  ...
  createCar(): void {
    inquirer
      ...
      .then((answers) => {
        const car = new Car(
          // TODO: The generateVin method is static and should be called 
          //using the class name Cli, make sure to use Cli.generateVin() 
          //for creating a truck and motorbike as well!
          Cli.generateVin(),
          answers.color,
          answers.make,
          answers.model,
  ...
  createMotorbike(): void {
    inquirer
      ...
      //create wheel objects for front and rear wheels
        ...
        new Wheel(parseInt(answers.frontWheelBrand)),
        new Wheel(parseInt(answers.rearWheelDiameter)), 
        new Wheel(parseInt(answers.rearWheelBrand)),
        ];
